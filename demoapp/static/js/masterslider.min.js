...
window.averta = {},
    ...
    function(n) {
        ...
        t.onSwipeStart = function() {
        	...
        	this.$element.removeClass('add-blur');
            ...
            if (this.pselected = !1, this.moz && this.$element.css("margin-top", "0.1px"), this.$element.addClass('add-blur'), (this.link || this.video) && (this.view.removeEventListener(MSViewEvents.SWIPE_START, this.onSwipeStart, this), this.view.removeEventListener(MSViewEvents.SWIPE_CANCEL, this.onSwipeCancel, this)), this.bgvideo && (this.bgvideo.pause(), !this.autoPauseBgVid && this.vinit && (this.bgvideo.currentTime = 0)), this.selected) {
    ...
    function(n) {
        ...
        window.MasterSlider = function() {
            ...
            this.options.smoothHeight ? (this.htween && (this.htween.reset ? this.htween.reset() : this.htween.stop(!0)), this.htween = CTween.animate(this.slideController.view.$element, 300, {
                height: n
            }, {
                ease: "easeOutQuart"
